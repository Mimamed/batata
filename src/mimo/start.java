...
public class start 
{
	...
	static URL[] filer = { start.class.getResource("/Bilder/startMenu.jpg"), start.class.getResource("/Bilder/tabMenu.jpg"), start.class.getResource("/Bilder/flashcardMenu.jpg"), start.class.getResource("/Bilder/flashcardGame.jpg"), start.class.getResource("/Bilder/readingMenu.jpg"), start.class.getResource("/Bilder/flashcardList.jpg"), start.class.getResource("/Bilder/readingGame.jpg"), start.class.getResource("/Bilder/settings.jpg"), start.class.getResource("/Bilder/lessonMenu.jpg"), start.class.getResource("/Bilder/lessonGameBasics.jpg")};
	...
	static int radnummer = -antalrader;static String[] defaultWordList = {":substantiv;", "Jag=I<0><0><0>;", "Du=You (singular)<Du är en man><0><0>;", "Han=He<0><0><0>;", "Hon=She<0><0><0>;", "Det=It, That<0><0><0>;", "Den=It, That<0><0><0>;", "Vi=We<0><0><0>;", "Ni=You (plural)<Ni är kockar><0><0>;", "De=They<0><0><0>;", "Öl=Beer<0><0><0>;", "Äpple=Apple<0><0><0>;", "Vatten=Water<0><0><0>;", "Kvinna=Woman<0><0><0>;", "Man=Man<0><0><0>;", "Pojke=Boy<0><0><0>;", "Flicka=Girl<0><0><0>;", "Korv=Sausage<0><0><0>;", "Vin=Wine<0><0><0>;", "Kött=Meat<0><0><0>;", "Bröd=Bread<0><0><0>;", "Päron=Pear<0><0><0>;", "Grönsak=Vegetable<0><0><0>;", "Dryck=Drink<Vilken dryck vill du ha?><0><0>;", "Mjölk=Milk<0><0><0>;", "Kaffe=Coffee<0><0><0>;", "Te=Tea<0><0><0>;", "Alkohol=Alcohol<0><0><0>;", "Smör=Butter<0><0><0>;", "Skinka=Ham<0><0><0>;", "Barn=Child<0><0><0>;", "Hus=House<0><0><0>;", "Sverige=Sweden<0><0><0>;", "Europa=Europe<0><0><0>;", "Amerika=America<0><0><0>;", "Asien=Asia<0><0><0>;", "Mat=Food<0><0><0>;", "Kopp=Cup<En kopp kaffe, tack><0><0>;", "Glas=Glass<0><0><0>;", "Katt=Cat<0><0><0>;", "Hund=Dog<0><0><0>;", "Ko=Cow<0><0><0>;", "Gris=Pig<0><0><0>;", "Fågel=Bird<0><0><0>;", "Bonde=Farmer<0><0><0>;", "Orm=Snake<0><0><0>;", "Djur=Animal<0><0><0>;", "Får=Sheep<0><0><0>;", "Lejon=Lion<0><0><0>;", "Mus=Mouse<0><0><0>;", "Gräs=Grass<Gräs är grönt><0><0>;", "Skola=School<0><0><0>;", "Affär=Store, shop<0><0><0>;", "Bok=Book<0><0><0>;", "Svenska=Swedish language<0><0><0>;", "Arabiska=Arabic language<0><0><0>;", "Engelska=English language<0><0><0>;", "TV=TV<TVn är gammal><0><0>;", "Vad=What<0><0><0>;", "Arbete=Work, job<0><0><0>;", "Färg=Color<0><0><0>;", "Musik=Music<0><0><0>;", "Fisk=Fish<0><0><0>;", "Denna=This<Detta är inte bra><0><0>;", "Den här=This, this one<Det här gräset är grönt><0><0>;", "Den där=That, that one<Det där huset är litet><0><0>;", "Vem=Who<Vem är där?><0><0>;", "Kläder=Clothes<0><0><0>;", "Sko=Shoe<0><0><0>;", "Pengar=Money<0><0><0>;", "Öga=Eye<0><0><0>;", "Huvud=Head<Hunden har ett hårt huvud><0><0>;", "Hand=Hand<0><0><0>;", "Öra=Ear<0><0><0>;", "Fot=Foot<0><0><0>;", "Hår=Hair<0><0><0>;", "Arm=Arm<0><0><0>;", "Ben=Leg, bone<0><0><0>;", "Mun=Mouth<0><0><0>;", "Tidning=Newspaper<0><0><0>;", "Inget=Nothing<Allt eller inget><0><0>;", ":verb;", "Vara=To be<Vi är här><0><0>;", "Äta=To eat<0><0><0>;", "Dricka=To drink<0><0><0>;", "Gilla=To like<0><0><0>;", "Komma från=To come from<Jag kommer från Sverige><0><0>;", "Laga=To cook<De lagar pasta><0><0>;", "Laga=To fix<Hon lagade min cykel><0><0>;", "Gå=To go, to walk<Jag går till affären><0><0>;", "Höra=To hear<0><0><0>;", "Se=To see<0><0><0>;", "Skriva=To write<Skriver ni en bok?><0><0>;", "Läsa=To read<Jag läser tidningen><0><0>;", "Tala=To speak, to talk<Talar du engelska?><0><0>;", "Hata=To hate<0><0><0>;", "Älska=To love<Jag älskar dig><0><0>;", "Kolla=To watch, to look<De kollar på tv><0><0>;", "Finnas=To exist, there be<Det finns ingen snö här><0><0>;", "Göra=To do, to make<Vad gör du?><0><0>;", "Lyssna=To listen<Lyssna på mig><0><0>;", "Heta=To be named, to be called<Jag heter Karl><0><0>;", "Ge=To give<Ge oss pengarna!><0><0>;", "Komma=To come<Han kommer hem><0><0>;", "Ha=To have<Jag har en stor katt><0><0>;", "Göra ont=To hurt<Min tå gör ont><0><0>;", "Klia=To itch<Deras hår kliar><0><0>;", "Säga=To say<0><0><0>;", "Sluta=To stop<Sluta springa><0><0>;", "Springa=To run<0><0><0>;", "Veta=To know<0><0><0>;", "Kunna=To be able to, to know, can<Kan djur läsa?><0><0>;", "Ta=To take<0><0><0>;", "Behöva=To need<0><0><0>;", ":describer;", "Stor=Big<0><0><0>;", "God=Well tasting<Maten är god><0><0>;", "God=Good (not evil)<0><0><0>;", "Hemma=At home<Jag är hemma älskling><0><0>;", "Bra=Good, well, fine<Ge mig en bra gaffel><0><0>;", "Svart=Black<0><0><0>;", "Vit=White<0><0><0>;", "Grön=Green<0><0><0>;", "Röd=Red<0><0><0>;", "Väldigt=Very<Väldigt bra><0><0>;", "Fin=Pretty<Ditt hus är fint><0><0>;", "Färdig=Done, ready<Vi är färdiga för skolan><0><0>;", "Liten=Small, little<Små skor, liten sko><0><0>;", "Lite=A little, a bit<Vi talar lite svenska><0><0>;", "Vilken=Which<Vilken musik gillar du?><0><0>;", "Annan=Other<Har ni några andra färger?><0><0>;", "Blå=Blue<0><0><0>;", "Många=Many, a lot<Ni har många kläder><0><0>;", "Dålig=Bad<0><0><0>;", "All=All<Alla människor är djur><0><0>;", "Någon=Some, somebody, any<Har ni något te?><0><0>;", "Snabb=Quick, fast<0><0><0>;", "Långsam=Slow<0><0><0>;", "Smart=Smart<0><0><0>;", "Dum=Dumb, stupid<0><0><0>;", "Ingen=No, none, no one<0><0><0>;", ":function;", "Inte=Not<Inte roligt, skrattade inte><0><0>;", "Och=And<Vi och de><0><0>;", "Ja=Yes<0><0><0>;", "Nej=No<0><0><0>;", "Jo=Yes (against no)<Jo, det är möjligt><0><0>;", "Hej då=Goodbye<0><0><0>;", "Välkommen=Welcome<Välkommen till Stockholm><0><0>;", "Godmorgon=Good morning<0><0><0>;", "Goddag=Good day<0><0><0>;", "Godkväll=Good evening<0><0><0>;", "Godnatt=Good night<0><0><0>;", "Tack=Thank you, Thanks<Tack för maten><0><0>;", "Snälla=Please<Snälla gå inte dit><0><0>;", "Förlåt=Sorry<Förlåt för att jag lämnade><0><0>;", "Ursäkta (mig)=Excuse me<Ursäkta, har du en tändare?><0><0>;", "Nu=Now<0><0><0>;", "Var=Where<0><0><0>;", "Här=Here<0><0><0>;", "Varför=Why<0><0><0>;", "Hur=How<0><0><0>;", "Vart=Where to<Vart går ni?><0><0>;", "När=When<0><0><0>;", "Med=With<0><0><0>;", "En/Ett=One<0><0><0>;", "Två=Two<0><0><0>;", "Tre=Three<0><0><0>;", "Fyra=Four<0><0><0>;", "Fem=Five<0><0><0>;", "Sex=Six<0><0><0>;", "Sju=Seven<0><0><0>;", "Åtta=Eight<0><0><0>;", "Nio=Nine<0><0><0>;", "Tio=Ten<0><0><0>;", "I=In<Han är i duschen><0><0>;", "Idag=Today<0><0><0>;", "Igår=Yesterday<0><0><0>;", "Imorgon=Tomorrow<0><0><0>;", "Men=But<0><0><0>;", "Där=There<0><0><0>;", "Till=To<0><0><0>;", "Hit=Hither, (towards) here<Kom hit nu!><0><0>;", "Dit=Thither, (towards) there<0><0><0>;", "Eller=Or<Rött eller grönt><0><0>;", "Aldrig=Never<Mohammed får aldrig sin låt><0><0>;", "Kanske=Maybe<0><0><0>;", "Därför=Because<0><0><0>;", ":meningar;", "-"};
	...
	public static void läsFiler(File fil) throws FileNotFoundException
	{
		...
		checkaLista();
		System.out.println("llllllllllllllllll" + (start.wordList.size() - (1 + antalrader)));
		System.out.println("kkk: " + (start.radnummer/5) + " rad: " + (radnummer + 5) + " variabelns längd: " + wordList.size());
		fkOrdlista.labelFixare();
		System.out.println();
