...
public class start //mimamed kolla igenom ditt skit före du förstör allting, noob  //Jag tror mer det är jag som glömmer pulla då och då och därför förstör saker
{
	...
	public static void main(String[] Args)
	{
		...
		try
		{
			...
			if (!fil.exists())
			{
				filskapare = new Formatter(vägen);
	...
	public static void spararFiler()
	{
		...
		try {
			...
			Formatter spararen = new Formatter(vägen);
	...
	static void räknarTiden() throws Exception
	{
		
		if (new File("C:\\Users\\Public\\Downloads\\TimeCounter.txt").exists())
		{
			Scanner läsaren = new Scanner(new File("C:\\Users\\Public\\Downloads\\TimeCounter.txt"));
			String tempText = Integer.toString((läsaren.nextInt() + 1));
	...
	static class TidRäknaren implements ActionListener
	{
