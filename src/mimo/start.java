...
public class start 
{
	...
	static String[] defaultWordList = {":substantiv;", "ord=word<0><0>;", "bil=car<0><0>;", ":verb;", "prata=speak,talk<0><0>;", "hoppa=jump,hop<0><0>;", ":function?;", ":describer?;", ":meningar;", "-"};//82601895623013
